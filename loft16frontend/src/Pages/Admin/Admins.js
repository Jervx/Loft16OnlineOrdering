        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="container h-screen px-6 py-10 mx-auto">
            ...
            <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
              Loft 16 admins that make the online store possible & updated
            </p>
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4 pb-4">
              ...
              {!loadingData &&
                admin.map((adminUser, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col items-center text-gray-600 hover:text-white p-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-teal-500 dark:border-gray-700 dark:hover:border-transparent"
                    onClick={() => {
                      dispatch(
                        openInputModal({
                          title: "",
