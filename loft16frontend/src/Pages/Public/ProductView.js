            ...
            <div className="container px-5 py-24 mx-auto">
              ...
              /> */}
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <div className="flex flex-wrap my-5 space-y-2 defText-Col-2">
                  ...
                  <div className=" flex items-center mt-12 text-teal-500">
                    <p className="font-bold ">Description</p><CgDetailsLess className="ml-4 w-5 h-5"/>
                  </div>
                  <textarea className="leading-relaxed bg-transparent border-0 resize-none w-full py-4" disabled value={productDetail.description}>
                  </textarea>
